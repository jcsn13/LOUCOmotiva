...
void empilhar(pilha **p, int numero)
{
    ...
    if (*p == NULL)
    { // A Pilha está vazia, é o primeiro elemento que vamos inserir nela.
        *p = novo;
        (*p)->valor = numero;
        (*p)->prox = NULL;
    }
    ...
    { // A Pilha não está vazia. Inserimos no final.
...
void desempilhar(pilha **p)
{
    ...
    { //A Pilha tem mais de um elemento, então podemos desempilhar!
